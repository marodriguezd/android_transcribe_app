...
> **Versión declarada actualmente en Gradle:** 0.1.26 (`versionCode 28`, ver `app/build.gradle.kts`). La versión realmente publicada debe comprobarse en tags/releases; no asumir que coincide con este fichero.
>
